...
export const CATA_PRODUCT_REQUEST = "CATA_PRODUCT_REQUEST";
export const CATA_PRODUCT_SUCCESS = "CATA_PRODUCT_SUCCESS";
export const CATA_PRODUCT_FAIL = "CATA_PRODUCT_FAIL";
